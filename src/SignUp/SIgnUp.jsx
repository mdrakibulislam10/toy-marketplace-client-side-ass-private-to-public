        ...
        <div className="w-full max-w-xs mx-auto mb-12">
            ...
            <form className="bg-white shadow-xl rounded px-8 py-10 mb-4">
                <div className="mb-4">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" required placeholder="Your Name" />
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="image" type="photo" required placeholder="paste your photo url" />
                </div>
                <div className="flex items-center justify-between">
                    <button className="bg-blue-500 hover:bg-blue-700 w-full mt-2 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                        Sign up
                    </button>
                </div>
