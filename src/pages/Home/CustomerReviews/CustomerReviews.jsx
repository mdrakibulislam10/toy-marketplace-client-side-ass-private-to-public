                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-6">
                    <div className="flex items-center justify-center">
                        <div className="text-start">
                            ...
                            <p className="font-semibold text-lg">Write about our service and how we can improve more feel free to write the text box.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleReviewPost} className="">
                        <div className="w-full px-3">
                            ...
                            <input className="btn bg-sky-700 border-0 hover:bg-sky-600 mt-2" type="submit" value="Post Review" />
                        </div>
