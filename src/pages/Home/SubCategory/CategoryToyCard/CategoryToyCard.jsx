        ...
        <>
            <div className="w-full max-w-s border bg-gray-100 shadow-xl rounded-lg">
                ...
                <div className="px-5 pb-5">
                    <h5 className="text-2xl my-4 font-semibold tracking-tight text-gray-900">{toyName}</h5>

                    <div className="">
                        <div className="flex items-center mt-2.5 mb-5">
                            <Rating className='mx-1' style={{ maxWidth: 100 }} readOnly value={rating} />

                            <span className="bg-pink-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-pink-200 dark:text-blue-800 ml-3">{rating}</span>
